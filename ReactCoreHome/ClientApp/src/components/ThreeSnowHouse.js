...
import object from "./src/obj/snow.obj";

export class ThreeSnowHouse extends Component {
    displayName = ThreeSnowHouse.name
    ...
    componentDidMount() {
        ...
        function init() {
            ...
            var texture = textureLoader.load('./src/obj/snow.png');
            // model
            ...
            //loader.load('./src/obj/snow.obj', function (obj) {
            //    object = obj;
            //}, onProgress, onError);
